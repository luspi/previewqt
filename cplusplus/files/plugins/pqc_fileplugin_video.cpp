...
const QImage PQCFilePluginVideo::loadImage(QString path, QSize requestedSize, QSize &origSize, QString &error) {
    ...
    const QString msg = "Failed to load video thumbnail";
    qWarning() << msg;
    error += msg % "\n";
    return QImage();
...
const QJsonObject PQCFilePluginVideo::loadJSON(QString path, QVariantMap extraArguments) {
