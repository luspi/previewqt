...
PQCLoadFilePoppler::PQCLoadFilePoppler() {}

QString PQCLoadFilePoppler::load(QString filename, QSize maxSize, QSize &origSize, QImage &img) {
    ...
    origSize = QSize(-1,-1);
    errormsg = "Failed to load image, Poppler not supported by this build of PreviewQt!";
    qWarning() << errormsg;
    return errormsg;
