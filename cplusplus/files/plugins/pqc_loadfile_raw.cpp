...
PQCLoadFileRAW::PQCLoadFileRAW() {}

QString PQCLoadFileRAW::load(QString filename, QSize maxSize, QSize &origSize, QImage &img, QImage &fullImage) {
    ...
    origSize = QSize(-1,-1);
    errormsg = "Failed to load image, LibRaw not supported by this build of PreviewQt!";
    qWarning() << errormsg;
    return errormsg;
