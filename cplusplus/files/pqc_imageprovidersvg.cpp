...
PQCImageProviderSVG::PQCImageProviderSVG() : QQuickImageProvider(QQuickImageProvider::Image) {}

PQCImageProviderSVG::~PQCImageProviderSVG() {}

QImage PQCImageProviderSVG::requestImage(const QString &url, QSize *origSize, const QSize &requestedSize) {
