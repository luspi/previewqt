...
#ifndef VQCImageFormats_H
#define VQCImageFormats_H

#include <QObject>
#include <QVariantMap>
#include <QtSql/QSqlDatabase>

class VQCImageFormats : public QObject {

    Q_OBJECT

public:
    static VQCImageFormats& get() {
        static VQCImageFormats instance;
        return instance;
    }

    VQCImageFormats(VQCImageFormats const&)     = delete;
    void operator=(VQCImageFormats const&) = delete;
