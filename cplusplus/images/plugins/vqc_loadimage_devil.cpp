...
VQCLoadImageDevil::VQCLoadImageDevil() {}

QString VQCLoadImageDevil::load(QString filename, QSize maxSize, QSize &origSize, QImage &img) {
    ...
    QMutexLocker locker(&VQCLoadImageDevilMutex::get().devilMutex);
...
#ifdef VQMDEVIL
QString VQCLoadImageDevil::checkForError() {
