...
!define PRODUCT_NAME    "PreviewQt"
!define APP_PUBLISHER   "Lukas Spies"
!define PROGEXE         "previewqt.exe"

Name "PreviewQt"
OutFile "previewqt-${VERSION}.exe"
InstallDir "$LOCALAPPDATA\Programs\PreviewQt"
...
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_KEY "Software\Lukas Spies\PreviewQt"

!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUENAME "InstallDir"

; Install per-machine applications in Program Files.
!define MULTIUSER_INSTALLMODE_INSTDIR "PreviewQt"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\files\previewqt.exe"
...
!define MUI_ICON "assets\previewqt_install.ico"
!define MUI_UNICON "assets\previewqt_uninstall.ico"
...
Function WelcomeLeaveNotSilent
    IfSilent doNothing 0
        ...
        IfFileExists "$INSTDIR\files\*.*" doNothing 0
            MessageBox MB_OK "The installer for PreviewQt was completely reworked with improved file and registry handling. To take advantage of this, the previous installation first needs to be removed.$\r$\n$\r$\nClosing this message box will terminate the installer and launch the uninstaller. After completing the uninstall, simply relaunch this installer."
...
Function .onInit
    ...
    Pop $0
    ${If} $0 == "admin"
        StrCpy $INSTDIR "$PROGRAMFILES64\PreviewQt"
    ${EndIf}
