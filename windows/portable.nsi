...
; When defined, this calls `signtool sign` 2 times during compilation:
; - previewqt.exe
; - final portable exe
; ------------------------------------------------------------
...
Icon "assets\previewqt_portable.ico"
OutFile "previewqt-portable-${VERSION}.exe"
...
Section
    ...
    !ifdef SIGN_EXE_AUTOMATICALLY
        !system "signtool sign -v -tr http://time.certum.pl -fd SHA256 -td SHA256 app_portable\previewqt.exe" = 0
    !endif
    ...
    ExecWait '"$pluginsdir\previewqt.exe" "$exedir" $CMDLINE'
