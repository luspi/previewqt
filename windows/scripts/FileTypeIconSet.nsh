...
Function FileTypeIconSetSilent
    ...
    ReadRegStr $iconRegValue ShCtx "Software\PreviewQt" "FileTypeIconSetSelected"
...
Function FileTypeIconSetPage
    ...
    ; They are outlines in the FAQ on https://previewqt.org
    ...
    ${If} $iconPreviouslySelected == 0
        ${NSD_CreateLabel} 0 0 100% 30u \
            "PreviewQt provides file type icons for all file types with which it has been associated. Here you can choose between two possible icon sets. To change the file icon set later, please refer to the FAQ on PreviewQt's website."
        Pop $0
    ${Else}
        ${NSD_CreateLabel} 0 0 100% 30u \
            "You already selected a file type icon set in a previous installation. To change the file type icon set now, please refer to the FAQ on PreviewQt's website for instructions."
        Pop $0
    ${EndIf}
    ...
    ${NSD_CreateLabel} 0 120u 100% 35u \
        "If you want to contribute a file icon set to PreviewQt, please check out this FAQ and if you have any questions don't hesitate to get in touch: https://previewqt.org/about"
    Pop $0
