...
Section "Application"
    ...
    !ifdef SIGN_EXE_AUTOMATICALLY
        !system "signtool sign -v -tr http://time.certum.pl -fd SHA256 -td SHA256 app\files\previewqt.exe" = 0
    !endif
    ...
    WriteRegStr ShCtx \
        "Software\Microsoft\Windows\CurrentVersion\Uninstall\PreviewQt" \
        "DisplayName" \
        "PreviewQt"
