...
Section "Uninstall"
    ...
    ${If} $MultiUser.InstallMode == "AllUsers"
        ...
        Delete "$SMPROGRAMS\PreviewQt\PreviewQt.lnk"
        RMDir "$SMPROGRAMS\PreviewQt"
    ...
    SetRegView 32
    DeleteRegKey ShCtx "Software\Microsoft\Windows\CurrentVersion\Uninstall\PreviewQt"
